  ...
  const farmsList = useCallback(
    (farmsToDisplay): FarmWithStakedValue[] => {
      ...
      let farmsToDisplayWithAPY: FarmWithStakedValue[] = farmsToDisplay.map((farm) => {
        ...
        //   return farm
        // }
        const cakeRewardPerBlock = new BigNumber(farm.snakeswapPerBlock || 1)
  ...
  return (
    <>
      <Header>
        ...
        <Text>
          <AddressLink
            href="https://doc.snakeswap.live/tokennomics/burn-mechanism-and-fee-farming"
            color="text"
            external
          >
      ...
      <Page>
        ...
        {renderContent()}
        <Image src="/images/snakeswap/8.png" alt="illustration" width={1352} height={587} responsive />
      </Page>
    </>
  )
}
