  ...
  return (
    <Page>
      ...
      <Content>
        <div>
          <Block>
            <Title as="h2">{TranslateString(999, 'Coming Soon to SnakeSwap DeFi.')}</Title>
            <Text mb={3}>
              {TranslateString(
                504,
            ...
            <Text mb={3}>
              <LiquidityLink href="https://swap.snakeswap.live/#/add/ETH/0x660F25d08D2d8A2dD55659B6F0dd94f973fa9B32">
          ...
          <Block>
            ...
            <Text mb={3}>
              {TranslateString(
                514,
                'Launch your project with SnakeSwap DeFi, Binance Smart Chain’s most-used AMM project and liquidity provider, to bring your token directly to the most active and rapidly growing community on BSC.',
              )}
            </Text>
            <Button
              as="a"
